...
@Component({
	...
	imports: [
		CommonModule,
		FormatNumberKPipe, FormatNumberKDecimalPipe,
		NzCommentModule,
		NzAvatarModule,
		NzIconModule,
		NzToolTipModule,
		...
		this.comments.push(
			...
			},
			{
				...
				avatar:
					'',
				contentText:
					'aquí les dejo por si tienen frío, de nada 😌',
				contentImage: [
					'https://i.pinimg.com/originals/90/0b/e6/900be635a7e0d8830a9280f36c2a8078.gif'
				],
				likes: 59851,
				mehs: 20796,
				dislikes: 19005,
			...
			},
			{
				...
				contentText: 'pvto el que lo lea 🤙',
				contentImage: [],
				likes: 8785,
				mehs: 1509,
				dislikes: 1009,
